...
in
{
  ...
  masqueradeInterfaces6 =
    if nat6Enabled then
      ...
      [ ];
  masqueradeSourcePrefixes4 = builtins.trace "DBG internet=${builtins.toJSON internetTenantNames} nonInternet=${builtins.toJSON nonInternetTenantPrefixes4} siteNat=${builtins.toJSON siteNat44SourcePrefixes}" (if nat4Enabled then nat44SourcePrefixes else [ ]);
