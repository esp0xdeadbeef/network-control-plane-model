...
run_case "SMS-010/SMS-030" "${repo_root}/tests/test-service-exposure-classification.sh"
...
run_case "SMS-020" "${repo_root}/tests/test-overlay-client-gua-mode-contract.sh"
run_case "SMS-030" "${repo_root}/tests/test-provider-bootstrap-dns-contract.sh"
run_case "SMS-030" "${repo_root}/tests/test-fs250-core-role-authority-carry-through.sh"
