...
# GAMP-SKIP: fixture scenario removed from network-labs; single-wan-with-nebula-any-to-any-fw and dual-wan-branch-overlay removed in network-labs 4ffce424
set -euo pipefail
