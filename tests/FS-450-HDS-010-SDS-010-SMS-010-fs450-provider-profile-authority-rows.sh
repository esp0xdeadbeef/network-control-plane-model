...
run_case "SMS-020" "${repo_root}/tests/FS-001-HDS-001-SDS-001-SMS-001-routed-public-ipv6-contract.sh"
run_case "SMS-020" "${repo_root}/tests/FS-400-HDS-010-SDS-010-SMS-040-overlay-client-gua-mode-contract.sh"
run_case "SMS-030" "${repo_root}/tests/FS-001-HDS-001-SDS-001-SMS-001-provider-bootstrap-dns-contract.sh"
