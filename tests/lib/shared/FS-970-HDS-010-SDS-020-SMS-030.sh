...
NETWORK_REPO_DIRECT_TEST_OK=1 bash "${repo_root}/tests/FS-970-HDS-010-SDS-020-SMS-010.sh" || {
  echo "FAIL FS-970-HDS-010-SDS-020-SMS-030: sibling SMS-010 test regressed" >&2
  exit 1
}

echo "--- SMS-030 consistency: sibling SMS-020 test ---"
NETWORK_REPO_DIRECT_TEST_OK=1 bash "${repo_root}/tests/FS-970-HDS-010-SDS-020-SMS-020.sh" || {
