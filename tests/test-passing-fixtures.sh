#!/usr/bin/env bash
# GAMP-ID: RTM-RUNNER-CPM-PASSING-001
...
bash "${repo_root}/tests/test-example-dns-service-wan-forwarders.sh"
bash "${repo_root}/tests/test-core-dns-service-public-egress-forwarding.sh"
...
bash "${repo_root}/tests/test-upstream-selector-nebula-underlay-core-transit.sh"
bash "${repo_root}/tests/test-policy-no-transit-mesh-forwarding.sh"
bash "${repo_root}/tests/test-s88-router-roles-have-firewall-policy.sh"
bash "${repo_root}/tests/test-overlay-ipv6-auto-allocation.sh"
bash "${repo_root}/tests/test-overlay-provisioning-provider-neutral.sh"
bash "${repo_root}/tests/test-nebula-overlays-have-provider-contract.sh"
bash "${repo_root}/tests/test-provider-bootstrap-dns-contract.sh"
bash "${repo_root}/tests/test-fs440-provider-authority-rows.sh"
bash "${repo_root}/tests/test-fs450-provider-profile-authority-rows.sh"
bash "${repo_root}/tests/test-transit-default-routes-are-classified.sh"
bash "${repo_root}/tests/test-policy-source-scope-preserved.sh"
bash "${repo_root}/tests/test-sitec-dmz-dns-route-loop.sh"
bash "${repo_root}/tests/test-dns-killswitch-policy-matrix.sh"
bash "${repo_root}/tests/test-public-dns-flow-classification.sh"
bash "${repo_root}/tests/test-policy-derived-dns-upstreams.sh"
bash "${repo_root}/tests/test-dns-semantic-core-carry-through.sh"
...
bash "${repo_root}/tests/test-example-downstream-local-service-forwarding.sh"
