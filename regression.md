...
350 src/cpm/resolve-firewall-intent.nix | state=watch | reason=split policy deny contract assembly and per-family NAT target assembly from forwarding-entry wiring before adding more firewall behavior
